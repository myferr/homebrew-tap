class Deo < Formula
  ...
  homepage "https://github.com/myferr/deo"
  version "1.0.0"
  license "MIT"
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/myferr/deo/releases/download/v1.0.0/deo-macos-arm64"
      sha256 "9cb87a701e5b719b0016817050e51fc5fbfa250b3ba2465ba899de1d3f48eb4e"
    else
      url "https://github.com/myferr/deo/releases/download/v1.0.0/deo-macos-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/myferr/deo/releases/download/v1.0.0/deo-linux-arm64"
      sha256 "4aa3312167bb3230c9c0d4bd674be34118ec0651b1b436d97cddf7a6f9e6ddcd"
    else
      url "https://github.com/myferr/deo/releases/download/v1.0.0/deo-linux-amd64"
